...
class Database:
    ...
    def create_menu(self):
        while True:
            self.console.clear()
            self.console.print(Panel("=== Create Menu ===", style="bold magenta"))
            choice = Prompt.ask("\n1. Insert Landowner\n2. Insert Property\n3. Insert Lease\n4. Insert Tenant\n5. Insert Rent Payment\n6. Insert Maintenance Request\n7. Insert Document\n8. Exit\nEnter choice:", choices=["1", "2", "3", "4", "5", "6", "7", "8"])
            if choice == "1":
    ...
    def testing_menu(self):
        while True:
            self.console.clear()
            self.console.print(Panel("=== Testing Menu ===", style="bold magenta"))
            choice = Prompt.ask("\n1. Calculate rent payment\n2. Search property\n3. Transfer ownership\n4. Exit\nEnter choice:", choices=["1", "2", "3", "4"])
            if choice == "1":
    ...
    def display_data(self):
        while True:
            self.console.clear()
            self.console.print(Panel("=== Display Data ===", style="bold magenta"))
            table_name = Prompt.ask("Enter table name (or type 'exit' to go back):")
            ...
            if rows:
                table = Table()
                for column_name in [description[0] for description in self.cur.description]:
